        ...
        <fieldset class="py-5">
            ...
            <form method="post" action=""> 
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" id="prodi" name="prodi">
                            <?php foreach ($as_prodi as $key => $value): ?>
                                <option value="<?= $key ?>">
                                    <?= $value ?>
                                </option>
                            <?php endforeach ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <?php foreach ($as_skill as $tech => $nilai): ?>
                            <div class="form-check form-check-inline">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" id="domisili" name="domisili">
                            <?php foreach ($as_domisili as $value): ?>
                                <option value="<?= $value ?>">
                                    <?= $value ?>
                                </option>
                            <?php endforeach ?>
...
<body>
    <div class="container">
        <h2 class="mt-5">Hasil Registrasi</h2>
        <div class="row mt-3">
            <div class="col-md-6">
                <ul class="list-group">
                    ...
                    <li class="list-group-item"><strong>Program Studi :</strong> <?= $as_prodi[$prodi] ?></li>
